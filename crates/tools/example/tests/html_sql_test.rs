...
mod test {
    ...
    impl Row for MockRow {
        fn meta_data(&self) -> Box<dyn MetaData> {
            Box::new(MockRowMetaData { sql: self.sql.clone() }) as Box<dyn MetaData>
        }
    ...
    fn test_test_if() {
        let f = async move {
            ...
            htmlsql!(test_if(rb: &RBatis, id: &u64)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_test_null() {
        let f = async move {
            ...
            htmlsql!(test_null(rb: &RBatis, id: Option<i32>)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_method_call() {
        let f = async move {
            ...
            htmlsql!(test_method_call(rb: &RBatis, id: Option<i32>)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_binary() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_binary(rb: &RBatis, id: i32, b:bool)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_unary() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_unary(rb: &RBatis, id: i32)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_paren() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_paren(rb: &RBatis, id: i32)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_field() {
        let f = async move {
            ...
            htmlsql!(test_field(rb: &RBatis, t: MockTable)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_reference() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_reference(rb: &RBatis, t: MockTable)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_index() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_index(rb: &RBatis, arr: Vec<i32>, map:HashMap<String,String>)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_lit() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_lit(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_where_empty() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_where_empty(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_where_sql() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_where_sql(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_bind() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_bind(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_choose() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_choose(rb: &RBatis,a:i32)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_for() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_for(rb: &RBatis,ids:Vec<i32>)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_for_item() {
        let f = async move {
            ...
            htmlsql!(test_for_item(rb: &RBatis,ids:Vec<Value>)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_trim() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_trim(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_trim2() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_trim2(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_trim3() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_trim3(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_include() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_include(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
    ...
    fn test_set() {
        let f = async move {
            ...
            let queue = Arc::new(SyncVec::new());
            rb.set_intercepts(vec![Arc::new(MockIntercept::new(queue.clone()))]);
            htmlsql!(test_set(rb: &RBatis)  -> Result<Value, Error> => "crates/tools/example/tests/test.html");
