...
/// }
/// let user_roles: Vec<SysUserRole> = vec![];
/// let role_ids_ref: HashMap<String, &SysUserRole> =
///     table_field_map!(&user_roles, role_id);
/// let role_ids: HashMap<String, SysUserRole> =
///     table_field_map!(user_roles, role_id);
/// ```
#[allow(unused_macros)]
#[macro_export]
...
/// }
/// let user_roles: Vec<SysUserRole> = vec![];
/// let role_ids_ref: BTreeMap<String, &SysUserRole> =
