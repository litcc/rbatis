...
impl PageRequest {
    ...
    pub fn new_total(page_no: u64, page_size: u64, total: u64) -> Self {
        ...
        Self { total, page_size, page_no, do_count: true }
    }
...
impl<T: Send + Sync> Page<T> {
    pub fn new(
        ...
        if page_no < 1 {
            return Self { total, page_size, page_no: 1u64, records, do_count: true };
        }
        Self { total, page_size, page_no, records, do_count: true }
    }
