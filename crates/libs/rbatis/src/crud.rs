...
///     let tables =
///         MockTable::select_in_column(rb, "id", &vec!["1", "2", "3"]).await;
///
...
/// use rbatis::executor::Executor;
/// use rbdc::db::ExecResult;
/// rbatis::htmlsql!(update_by_id(rb: &dyn Executor, id: &u64)  -> Result<ExecResult, rbatis::Error> => "crates/tools/example/example.html");
/// ```
/// query
///
/// ```rust
