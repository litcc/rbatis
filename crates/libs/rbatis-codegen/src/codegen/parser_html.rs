...
use crate::codegen::loader_html::load_html;
    ...
    for x in arg {
        match x.tag.as_str() {
            ...
            "foreach" => {
                ...
                let collection =
                    x.attrs.get("collection").unwrap_or(&empty_string).to_string();
                ...
                let separator =
                    x.attrs.get("separator").unwrap_or(&empty_string).to_string();
            ...
            "set" => {
                ...
                if let Some(collection) = collection {
                    let elements = make_sets(
                        collection,
                        skip_null,
                        skips.unwrap_or(&"id".to_string()),
                    );
