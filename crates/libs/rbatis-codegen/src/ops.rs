...
pub trait PartialOrd<Rhs: ?Sized = Self> {
    ...
    /// This method tests less than or equal to (for `self` and `other`) and is used
    /// by the `<=` operator.
    ///
    /// # Examples
    ///
    ...
    /// This method tests greater than (for `self` and `other`) and is used by the
    /// `>` operator.
    ///
    /// # Examples
    ///
    ...
    /// This method tests greater than or equal to (for `self` and `other`) and is
