...
pub struct DataRow {
    ...
    /// This uses `u32` instead of usize to reduce the size of this type. Values
    /// cannot be larger than `i32` in postgres.
...
impl Decode<'_> for DataRow {
    fn decode_with(buf: Bytes, _: ()) -> Result<Self, Error> {
        ...
        for _ in 0..cnt {
            // Length of the column value, in bytes (this count does not include
            // itself). Can be zero. As a special case, -1 indicates a
