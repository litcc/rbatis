...
/// The raw integer value sent over the wire; for locales with `frac_digits=2` (i.e.
/// most of them), this will be the value in whole cents.
///
/// E.g. for `select '$123.45'::money` with a locale of `en_US` (`frac_digits=2`),
/// this will be `12345`.
///
/// If the currency of your locale does not have fractional units, e.g. Yen, then
/// this will just be the units of the currency.
///
