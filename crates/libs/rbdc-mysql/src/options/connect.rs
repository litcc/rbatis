...
impl ConnectOptions for MySqlConnectOptions {
    fn connect(&self) -> BoxFuture<Result<Box<dyn Connection>, Error>> {
        Box::pin(async move {
            ...
            // After the connection is established, we initialize by configuring a
            // few connection parameters

            // https://mariadb.com/kb/en/sql-mode/

            // PIPES_AS_CONCAT - Allows using the pipe character (ASCII 124) as
            ...
            // // options.push_str(r#"SET sql_mode=(SELECT CONCAT(@@sql_mode,
            // ',PIPES_AS_CONCAT,NO_ENGINE_SUBSTITUTION')),"#); // options.
            // push_str(r#"time_zone='+00:00',"#); options.push_str(&
            // format!(     r#"SET NAMES {} COLLATE {};"#,
