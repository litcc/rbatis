...
impl ColumnDefinition {
    // NOTE: strings in-protocol are transmitted according to the client character
    // set       as this is UTF-8, all these strings should be UTF-8
...
impl ColumnType {
    ...
    //         ColumnType::VarChar | ColumnType::VarString if is_binary =>
    // "VARBINARY",
    //
