...
use crate::rt::TlsStream;
use crate::Error;

/// X.509 Certificate input, either a file path or a PEM encoded inline
/// certificate(s).
...
async fn configure_tls_connector(
    ...
    use crate::rt::native_tls::Certificate;
    use crate::rt::native_tls::TlsConnector;
